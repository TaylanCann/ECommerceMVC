        ...
        public FakeProductService()
        {
            _products = new List<Product>
            {
                ...
                new Product { Id = 3, Name = "MacBook Pro3" , Price=20000,Discount=0.09,Description="Perfect",CategoryId=1,
                    ImageURL="https://productimages.hepsiburada.net/s/44/222-222/10817626898482.jpg/format:webp"},
                new Product { Id = 4, Name = "MacBook Pro4" , Price=20000,Discount=0.09,Description="Perfect",CategoryId=1,
                    ImageURL="https://productimages.hepsiburada.net/s/44/222-222/10817626898482.jpg/format:webp"},
                new Product { Id = 5, Name = "MacBook Pro5" , Price=20000,Discount=0.09,Description="Perfect",CategoryId=1,
                    ImageURL="https://productimages.hepsiburada.net/s/44/222-222/10817626898482.jpg/format:webp"},
